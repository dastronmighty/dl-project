...
def PretrainedExperimentVGG13(directories, workers, aug,  extra_tag="", model_kwargs={"mode":"feature"}, **kwargs):
    pretrained_experiment(f"{extra_tag}PretrainedExperimentVGG13{'AUG' if aug else ''}", PretrainedVGG13, directories, 244, workers, model_kwargs, aug,  **kwargs)


def PretrainedExperimentVGG13BN(directories, workers, aug,  extra_tag="", model_kwargs={"mode":"feature"}, **kwargs):
    pretrained_experiment(f"{extra_tag}PretrainedExperimentVGG13BN{'AUG' if aug else ''}", PretrainedVGG13BN, directories, 244, workers, model_kwargs, aug,  **kwargs)
        

def PretrainedExperimentVGG16(directories, workers, aug,  extra_tag="", model_kwargs={"mode":"feature"}, **kwargs):
    pretrained_experiment(f"{extra_tag}PretrainedExperimentVGG16{'AUG' if aug else ''}", PretrainedVGG16, directories, 244, workers, model_kwargs, aug,  **kwargs)


def PretrainedExperimentVGG16BN(directories, workers, aug,  extra_tag="", model_kwargs={"mode":"feature"}, **kwargs):
    pretrained_experiment(f"{extra_tag}PretrainedExperimentVGG16BN{'AUG' if aug else ''}", PretrainedVGG16BN, directories, 244, workers, model_kwargs, aug,  **kwargs)


def PretrainedExperimentVGG19(directories, workers, aug,  extra_tag="", model_kwargs={"mode":"feature"}, **kwargs):
    pretrained_experiment(f"{extra_tag}PretrainedExperimentVGG19{'AUG' if aug else ''}", PretrainedVGG19, directories, 244, workers, model_kwargs, aug,  **kwargs)


def PretrainedExperimentVGG19BN(directories, workers, aug,  extra_tag="", model_kwargs={"mode":"feature"}, **kwargs):
    pretrained_experiment(f"{extra_tag}PretrainedExperimentVGG19BN{'AUG' if aug else ''}", PretrainedVGG19BN, directories, 244, workers, model_kwargs, aug,  **kwargs)
...
def PretrainedExperimentResNet18(directories, workers, aug,  extra_tag="", model_kwargs={"mode":"feature"}, **kwargs):
    pretrained_experiment(f"{extra_tag}PretrainedExperimentResNet18{'AUG' if aug else ''}", PretrainedResNet18, directories, 244, workers, model_kwargs, aug,  **kwargs)


def PretrainedExperimentResNet34(directories, workers, aug,  extra_tag="", model_kwargs={"mode":"feature"}, **kwargs):
    pretrained_experiment(f"{extra_tag}PretrainedExperimentResNet34{'AUG' if aug else ''}", PretrainedResNet34, directories, 244, workers, model_kwargs, aug,  **kwargs)


def PretrainedExperimentResNet50(directories, workers, aug,  extra_tag="", model_kwargs={"mode":"feature"}, **kwargs):
    pretrained_experiment(f"{extra_tag}PretrainedExperimentResNet50{'AUG' if aug else ''}", PretrainedResNet50, directories, 244, workers, model_kwargs, aug,  **kwargs)


def PretrainedExperimentResNet101(directories, workers, aug,  extra_tag="", model_kwargs={"mode":"feature"}, **kwargs):
    pretrained_experiment(f"{extra_tag}PretrainedExperimentResNet101{'AUG' if aug else ''}", PretrainedResNet101, directories, 244, workers, model_kwargs, aug,  **kwargs)


def PretrainedExperimentResNet152(directories, workers, aug,  extra_tag="", model_kwargs={"mode":"feature"}, **kwargs):
    pretrained_experiment(f"{extra_tag}PretrainedExperimentResNet152{'AUG' if aug else ''}", PretrainedResNet152, directories, 244, workers, model_kwargs, aug,  **kwargs)
